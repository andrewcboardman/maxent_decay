...
#	post = bayesian_utility_fcts.posterior('prior_max_entropy', user_parameters, 'likelihood_given_noise_vector', model_class.relative_signal, data[['pulse_time','chase_time']], data['measurement'], log_prob = True)
	#with jacobian
	post = bayesian_utility_fcts.posterior('prior_max_entropy', user_parameters, 'likelihood_given_noise_vector', model_class.relative_signal, data[['pulse_time','chase_time']], data['measurement'], log_prob = True, jacobian = model_class.jacobian_relative_signal)
